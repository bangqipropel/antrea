...
type ClusterClaimInformer interface {
	...
	Lister() v1alpha2.ClusterClaimLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MulticlusterV1alpha2().ClusterClaims(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MulticlusterV1alpha2().ClusterClaims(namespace).Watch(context.TODO(), options)
			},
		},
		&multiclusterv1alpha2.ClusterClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&multiclusterv1alpha2.ClusterClaim{}, f.defaultInformer)
}

func (f *clusterClaimInformer) Lister() v1alpha2.ClusterClaimLister {
	return v1alpha2.NewClusterClaimLister(f.Informer().GetIndexer())
}
